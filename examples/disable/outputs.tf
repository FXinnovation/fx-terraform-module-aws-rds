...
output "rds_cluster_arn" {
  value = module.disable.rds_cluster_arn
}

output "rds_cluster_id" {
  value = module.disable.rds_cluster_id
}
...
output "rds_cluster_storage_encrypted" {
  value = module.disable.rds_cluster_storage_encrypted
}
...
output "rds_cluster_instance_endpoints" {
  value = module.disable.rds_cluster_instance_endpoints
}

output "rds_cluster_instance_engines" {
  value = module.disable.rds_cluster_instance_engines
}

output "rds_cluster_instance_engine_versions" {
  value = module.disable.rds_cluster_instance_engine_versions
}

output "rds_cluster_instance_ports" {
  value = module.disable.rds_cluster_instance_ports
}

output "rds_cluster_instance_storage_encrypteds" {
  value = module.disable.rds_cluster_instance_storage_encrypteds
}

output "rds_cluster_instance_kms_key_ids" {
  value = module.disable.rds_cluster_instance_kms_key_ids
}

output "rds_cluster_instance_dbi_resource_ids" {
  value = module.disable.rds_cluster_instance_dbi_resource_ids
}

output "rds_cluster_instance_performance_insights_enableds" {
  value = module.disable.rds_cluster_instance_performance_insights_enableds
}
...
output "security_group_id" {
  value = module.disable.security_group_id
}

output "security_group_arn" {
  value = module.disable.security_group_arn
}

output "security_group_vpc_id" {
  value = module.disable.security_group_vpc_id
}

output "security_group_owner_id" {
  value = module.disable.security_group_owner_id
}

output "security_group_name" {
  value = module.disable.security_group_name
}

output "security_group_description" {
  value = module.disable.security_group_description
}

output "security_group_ingress" {
  value = module.disable.security_group_ingress
}

output "security_group_egress" {
  value = module.disable.security_group_egress
}
...
output "ssm_parameters_arns" {
  value = module.disable.ssm_parameters_arns
}

output "ssm_parameters_names" {
  value = module.disable.ssm_parameters_names
}

output "ssm_parameters_types" {
  value = module.disable.ssm_parameters_types
}

output "ssm_parameters_versions" {
  value = module.disable.ssm_parameters_versions
}

output "ssm_parameters_kms_key_arn" {
  value = module.disable.ssm_parameters_kms_key_arn
}

output "ssm_parameters_kms_key_id" {
  value = module.disable.ssm_parameters_kms_key_id
}

output "ssm_parameters_kms_alias_arn" {
  value = module.disable.ssm_parameters_kms_alias_arn
}

output "ssm_parameters_kms_alias_target_key_arn" {
  value = module.disable.ssm_parameters_kms_alias_target_key_arn
}

output "ssm_parameters_iam_policy_read_only_id" {
  value = module.disable.ssm_parameters_iam_policy_read_only_id
}

output "ssm_parameters_iam_policy_read_only_arn" {
  value = module.disable.ssm_parameters_iam_policy_read_only_arn
}

output "ssm_parameters_iam_policy_read_only_description" {
  value = module.disable.ssm_parameters_iam_policy_read_only_description
}

output "ssm_parameters_iam_policy_read_only_name" {
  value = module.disable.ssm_parameters_iam_policy_read_only_name
}

output "ssm_parameters_iam_policy_read_only_path" {
  value = module.disable.ssm_parameters_iam_policy_read_only_path
}

output "ssm_parameters_iam_policy_read_only_policy" {
  value = module.disable.ssm_parameters_iam_policy_read_only_policy
}

output "ssm_parameters_iam_policy_read_write_id" {
  value = module.disable.ssm_parameters_iam_policy_read_write_id
}

output "ssm_parameters_iam_policy_read_write_arn" {
  value = module.disable.ssm_parameters_iam_policy_read_write_arn
}

output "ssm_parameters_iam_policy_read_write_description" {
  value = module.disable.ssm_parameters_iam_policy_read_write_description
}

output "ssm_parameters_iam_policy_read_write_name" {
  value = module.disable.ssm_parameters_iam_policy_read_write_name
}

output "ssm_parameters_iam_policy_read_write_path" {
  value = module.disable.ssm_parameters_iam_policy_read_write_path
}

output "ssm_parameters_iam_policy_read_write_policy" {
  value = module.disable.ssm_parameters_iam_policy_read_write_policy
}
